...
<form id="formCalculate" name="formCalculate" action="" method="post" class="form-group bg-light p-3 my-2">
    <div class="form-group">
        ...
        <input type="number" class="form-control" name="a" id="a" aria-describedby="firstNumber" placeholder="Enter a number">
        <small class="form-text text-muted">Please enter a number to carry out an operation.</small>
    </div>
    <div class="form-group">
        <label for="b">Second number</label>
        <input type="number" class="form-control" name="b" id="b" aria-describedby="secondNumber" placeholder="Enter another number">
...
<div class="form-group rounded p-3 result">
    ...
    <small id="result" class="form-text text-muted">Your results will appear here.</small>
</div>

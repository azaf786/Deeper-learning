    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Recent Calculations</h5>
...
<!--        <select name="operation" id="operation" class="form-control" data-live-search="true">-->
<!--            <option selected>Select a category</option>-->
<!--            <option value="addition">Baby</option>-->
<!--            <option value="">Bath toys</option>-->
<!--            <option value="">Clothes, Shoes & Accessories</option>-->
<!--            <option value="">Baby Clothes, Shoes & Accessories</option>-->
<!--            <option value="">Health & Beauty</option>-->
<!--            <option value="">Hair Extensions & Wigs</option>-->
<!--            <option value="">Electronic Smoking, Parts & Accessories</option>-->
<!--            <option value="">Vaporizers</option>-->
<!--            <option value="">Home, Furniture & DIY</option>-->
<!--            <option value="">Appliances</option>-->
<!--            <option value="">DIY Tools & Workshop Equipment</option>-->
<!--            <option value="">Paint Sprayers</option>-->
<!--            <option value="">Mobile Phones & Communication</option>-->
<!--            <option value="">Home Phones & Accessories</option>-->
<!--            <option value="">Mobile & Smart Phones</option>-->
<!--            <option value="">Pet Supplies</option>-->
<!--            <option value="">Toys & Games</option>-->
<!--            <option value="">Vehicle Parts & Accessories</option>-->
<!--            <option value="">Tyres & Tubes</option>-->
<!--            <option value="">Wholesale & Job Lots</option>-->
